...
This is _not_ an audit. This is the codebase to learn how compilers and opcodes work.

Using huff, solidity, and yul for dissecting contracts and learning how they work under the hood.
...
```
git clone https://github.com/tagupta/Assembly-and-Formal-Verification.git
cd 1-horse-store
make
```
...
### Get Huff Contract Bytecode for V1
...
### Get Huff Contract Bytecode for V2

```
huffc src/horseStoreV2/HorseStore.huff  -b
solc --optimize --optimize-runs 20000 src/horseStoreV2/HorseStore.sol --bin | grep 60
```
